...
# API categories
_DANGEROUS_C = {
    "strcpy", "strcat", "sprintf", "vsprintf", "gets", "scanf", "memcpy",
    "alloca", "realpath", "tmpnam", "mktemp",
}
_COMMAND_EXEC = {
    "system", "popen", "execl", "execle", "execlp", "execv", "execve", "execvp",
    "posix_spawn", "fork", "vfork", "ShellExecuteA", "ShellExecuteW",
    "CreateProcessA", "CreateProcessW", "WinExec", "CreateProcess",
}
_NETWORK = {
    "socket", "connect", "bind", "listen", "accept", "recv", "send", "sendto",
    "recvfrom", "getaddrinfo", "gethostbyname", "inet_pton", "WSAStartup",
    "WSASocketA", "WSAConnect", "curl_easy_init", "curl_easy_perform",
}
_CRYPTO = {
    "EVP_EncryptInit", "EVP_DecryptInit", "AES_encrypt", "DES_encrypt",
    "RAND_bytes", "RAND_pseudo_bytes", "CryptAcquireContextA", "CryptEncrypt",
    "CryptDecrypt", "BCryptEncrypt", "BCryptDecrypt",
}
_DYNAMIC_CODE = {
    "dlopen", "dlsym", "LoadLibraryA", "LoadLibraryW", "GetProcAddress",
    "VirtualAlloc", "VirtualProtect", "mprotect", "mmap",
    "CreateRemoteThread", "NtMapViewOfSection", "NtCreateThreadEx",
}
_ANTI_DEBUG = {
    "IsDebuggerPresent", "CheckRemoteDebuggerPresent", "NtQueryInformationProcess",
    "NtSetInformationThread", "OutputDebugStringA", "ptrace",
}
_SANITIZER = {
    "__asan_report_load", "__asan_init", "__ubsan_handle",
    "__sanitizer_cov_trace", "__hwasan_init", "__msan_init",
    "__tsan_init",
}
